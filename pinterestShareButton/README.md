# Pinterest Share Button *- for the Mono Editor*
...
```
If share buttons are disabled on posts, it will throw an error in console. (not visible for normal users) If this is the case, there is no need for this script.